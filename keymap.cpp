...
uint8_t keymaps[LAYERS][ROWS][COLS] = {
  {
    ...
    { KEY_CAPSLOCK, KEY_P, KEY_L, KEY_COMMA, KEY_DOT, KEY_SEMICOLON, KEY_HASHTILDE, KEY_GRAVE },
    { KEY_MINUS, KEY_BACKSLASH, KEY_APOSTROPHE, KEY_SLASH, KEY_ESC, MOUSE_MOD, KEY_RIGHTBRACE, KEY_EQUAL },
    { KEY_BACKSPACE, KEY_ENTER, KEY_RIGHTALT, KEY_LEFTBRACE, KEY_MUTE, KEY_VOLUMEUP, KEY_VOLUMEDOWN, KEY_HELP }
  },
  {
    ...
    { KEY_DELETE, 0, KEY_RIGHTALT, 0, KEY_F11, KEY_F12, KEY_F13, KEY_F14 }
  },
  {
