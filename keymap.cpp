...
uint8_t keymaps[LAYERS][ROWS][COLS] = {
  {
    ...
    { KEY_DELETE, KEY_ENTER, KEY_RIGHTALT, KEY_LEFTBRACE, KEY_MUTE, KEY_VOLUMEUP, KEY_VOLUMEDOWN, KEY_HELP }
  },
  {
    ...
    { 0, 0, KEY_RIGHT, 0, 0, 0, 0, 0 },
    { KEY_F11, 0, 0, 0, 0, MOUSE_MOD, 0, KEY_F12 },
    { 0, 0, KEY_RIGHTALT, 0, KEY_MUTE, KEY_VOLUMEUP, KEY_VOLUMEDOWN, KEY_HELP }
  },
  {
    ...
    { MOUSE_KEY_DOWN, 0, 0, 0, 0, 0, MOUSE_WHEEL_DOWN, MOUSE_KEY_UP },
